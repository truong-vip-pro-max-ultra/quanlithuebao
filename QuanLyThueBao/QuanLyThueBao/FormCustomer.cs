...
namespace QuanLyThueBao
{
    public partial class FormCustomer : Form
    {
        ...
        public FormCustomer()
        {
           ...
           /* avatar.Image = new Bitmap(Application.StartupPath + "\\Images\\avtdefault.png");
            imgIdCardFront.Image = new Bitmap(Application.StartupPath + "\\Images\\frontbg.png");
            imgIdCardBack.Image = new Bitmap(Application.StartupPath + "\\Images\\backbg.png");*/
            resetImg();
        ...
        {
            avatar.ImageLocation = Application.StartupPath + "\\Images\\avtdefault.png";
            imgIdCardFront.ImageLocation = Application.StartupPath + "\\Images\\frontbg.png";
            imgIdCardBack.ImageLocation = Application.StartupPath + "\\Images\\backbg.png";
            avatar.Image = new Bitmap(Application.StartupPath + "\\Images\\avtdefault.png");
            imgIdCardFront.Image = new Bitmap(Application.StartupPath + "\\Images\\frontbg.png");
            imgIdCardBack.Image = new Bitmap(Application.StartupPath + "\\Images\\backbg.png");
        }
       ...
       /* private bool IsValidEmail(string email)
        ...
        {
            if (avatar.ImageLocation == Application.StartupPath + "\\Images\\avtdefault.png")
            {
                this.Alert("Vui Lòng Chọn Ảnh Chân Dung", FormAlert.enmType.Info);
                return false;
            }
            if (imgIdCardFront.ImageLocation == Application.StartupPath + "\\Images\\frontbg.png")
            {
                this.Alert("Vui Lòng Chọn Ảnh CMND/CCCD Mặt Trước", FormAlert.enmType.Info);
                return false;
            }
            if (imgIdCardBack.ImageLocation == Application.StartupPath + "\\Images\\backbg.png")
            {
