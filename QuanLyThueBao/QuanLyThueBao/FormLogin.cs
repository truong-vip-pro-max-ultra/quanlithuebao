...
namespace QuanLyThueBao
{
    public partial class FormLogin : Form
    {
        ...
        public FormLogin()
        {
            ...
            picOne.Image = new Bitmap(Application.StartupPath + "\\Images\\top1.png");
            picWorld.Image = new Bitmap(Application.StartupPath + "\\Images\\world.png");
            picUser.Image = new Bitmap(Application.StartupPath + "\\Images\\username.png");
            picKey.Image = new Bitmap(Application.StartupPath + "\\Images\\key.png");
            btnLogin.Image = new Bitmap(Application.StartupPath + "\\Images\\login.png");
