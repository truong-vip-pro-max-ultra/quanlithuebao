...
namespace QuanLyThueBao
{
    public partial class FormManager : Form
    {
        ...
        {
            btnPhone.Image = new Bitmap(Application.StartupPath + "\\Images\\phone.png");
            btnCustomer.Image = new Bitmap(Application.StartupPath + "\\Images\\customer.png");
            btnService.Image = new Bitmap(Application.StartupPath + "\\Images\\service.png");
            btnNetwork.Image = new Bitmap(Application.StartupPath + "\\Images\\network.png");
            btnRegion.Image = new Bitmap(Application.StartupPath + "\\Images\\region.png");
            ...
            btnReportBill.Image = new Bitmap(Application.StartupPath + "\\Images\\bill.png");
            btnReportAllBill.Image = new Bitmap(Application.StartupPath + "\\Images\\allbill.png");
