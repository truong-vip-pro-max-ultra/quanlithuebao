...
namespace QuanLyThueBao
{
    public partial class FormReportBill : Form
    {
        ...
        public void showBillAllPhone()
        {
            ...
            reportBill.LocalReport.ReportPath = Application.StartupPath + "\\Report\\reportBill.rdlc";
            if (DT.Rows.Count > 0)
            {
                ...
                if (checkPhone())
                {
                    ...
                    else
                    {
                        ...
                        if (DT.Rows.Count > 0)
                        {
                            ...
                            reportBill.ProcessingMode = Microsoft.Reporting.WinForms.ProcessingMode.Local;
                            //reportBill.LocalReport.ReportPath = @"E:\Csharp\QuanLyThueBao\QuanLyThueBao\QuanLyThueBao\reportBill.rdlc";
                            reportBill.LocalReport.ReportPath = Application.StartupPath + "\\Report\\reportBill.rdlc";
                            if (DT.Rows.Count > 0)
                            {
                                ReportDataSource rds = new ReportDataSource();
