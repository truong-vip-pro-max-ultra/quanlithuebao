...
namespace QuanLyThueBao
{
    public partial class FormUsers : Form
    {
        ...
        {
            btnAccount.Image = new Bitmap(Application.StartupPath + "\\Images\\account.png");
            btnService.Image = new Bitmap(Application.StartupPath + "\\Images\\service.png");
            btnCard.Image = new Bitmap(Application.StartupPath + "\\Images\\card.png");
            btnReport.Image = new Bitmap(Application.StartupPath + "\\Images\\report.png");
            btnOption.Image = new Bitmap(Application.StartupPath + "\\Images\\option.png");
            btnCloseChildForm.Image = new Bitmap(Application.StartupPath + "\\Images\\close.png");
            btnChangePw.Image = new Bitmap(Application.StartupPath + "\\Images\\changepw.png");
            btnLogout.Image = new Bitmap(Application.StartupPath + "\\Images\\logoutacc.png");
            btnServiceReged.Image = new Bitmap(Application.StartupPath + "\\Images\\servicereged.png");
            btnHistoryRecharge.Image = new Bitmap(Application.StartupPath + "\\Images\\historyrecharge.png");
            btnCall.Image = new Bitmap(Application.StartupPath + "\\Images\\call.png");
            btnMess.Image = new Bitmap(Application.StartupPath + "\\Images\\mess.png");
            btnNotification.Image = new Bitmap(Application.StartupPath + "\\Images\\notification.png");
            btnBill.Image = new Bitmap(Application.StartupPath + "\\Images\\allbill.png");
            this.Icon = new Icon(Application.StartupPath + "\\Images\\administrator.ico");
        }
